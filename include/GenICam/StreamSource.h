...
{
	//帧统计
	uint32_t    imageError;				///< 图像错误帧数
	uint32_t    lostPacketBlock;		///< 丢包帧数
...
typedef struct StreamStatisticsInfo
{
	...
	union
	{
		PCIEStreamStatisticsInfo pcieStatisticsInfo;
		U3VStreamStatisticsInfo u3vStatisticsInfo;
		GigEStreamStatisticsInfo gigeStatisticsInfo;
	};
