...
void VisionArrows_Rotate::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    painter->drawLine(QPointF(m_width-m_width/3,0),QPointF(m_width,m_height/2));
    painter->drawLine(QPointF(m_width-m_width/3,m_height),QPointF(m_width,m_height/2));
    painter->drawLine(QPointF(m_width-m_width/3,0),QPointF(m_width-m_width/3,m_height));
}
