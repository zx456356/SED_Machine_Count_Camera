...
public:
     ...
     * @param       实现有难度，暂时不做
     */
    void splitChain(QPointF splitPoint){Q_UNUSED(splitPoint)}

    /**
     * @brief       合并 -- 将链上的两点之间的所有的点合并，todo
     * @param       实现有难度，暂时不做
     */
    void mergeChain(QPointF mergePoint1,QPointF mergePoint2){Q_UNUSED(mergePoint1)Q_UNUSED(mergePoint2)}
