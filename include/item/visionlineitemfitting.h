...
public:
     ...
     */
    explicit VisionLineItemFitting(bool bEdit = true,qreal penWidth = 0, bool color_enable = false,
     ...
     * @param       p1 p2 起点和终点
     */
    void setLineFitting(QPointF p1,QPointF p2,qreal length = 0);
